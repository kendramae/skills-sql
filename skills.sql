...
SELECT * FROM Models ORDER BY brand_name LIMIT 11 OFFSET 14;
...
-- left joins will give you back all the information requested from the left table
-- regardless of whether it can be linked to information in the right table. inner
-- joins only give you back the information that can be linked.
...
-- 2015    Subaru     Outback
INSERT INTO Models (year, brand_name, name) VALUES (2015, 'Malibu', 'Chevrolet');
...
INSERT INTO Awards (name, year, winner) 
    VALUES ('IIHS Safety Award', 2015, (SELECT id 
        FROM Models WHERE year = 2015 AND 
        name = 'Chevrolet' AND 
        brand_name = 'Malibu')
    );
